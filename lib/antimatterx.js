/*!
 * AntiMatter-X JavaScript Library v1.0.3
    ...
    var lib = {
        ...
        setWallpaper: function(src, cover) { // 壁紙を設定する
            ...
            if (lib.isType(src, ["String", "Null", "Undefined"])) {
                var toDataURL_flag = (lib.parseURL(src).domainname === "i.imgur.com"),
                    cv = document.createElement("canvas"),
                ...
                img.onload = function() {
                    ...
                    lib.setCSS(document.body, {
                        backgroundImage: src === "" || lib.isType(src, ["Null", "Undefined"]) ? "none" : 'url("' + (toDataURL_flag ? cv.toDataURL("image/png") : src) + '")',
                ...
                if (toDataURL_flag) img.crossOrigin = "anonymouse";
                img.src = src;
            };
            return e;
        },
