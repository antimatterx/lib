                                ...
                                if (typeof x === 'object') {
                                    var isArr = Array.isArray(x),
                                        literal = isArr ? { left: '[', right: ']' } : {
                                            left: (function () {
                                                if (x.constructor === Object || typeof x.constructor !== 'function' || x.constructor.name === '') return '';
                                    ...
                                    for (var i = 0; i < propKeys.length; i++) {
                                        var k = propKeys[i],
                                            descript = Object.getOwnPropertyDescriptor(x, k) ||
                                                Object.getOwnPropertyDescriptor(typeof Object.getPrototypeOf === 'function' ? Object.getPrototypeOf(x) : x.__proto__, k) ||
                                                {};
                                        res.push((function () {
