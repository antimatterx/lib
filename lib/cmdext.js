(function(globalObject) {
    ...
    // クラス
    _getExportTarget().CmdExt = (function(oldCmdExt) {
        // コンストラクタ
        ...
        p.noConflict = function() { // CmdExtを前のものに戻した後、CmdExtを返す
            _getExportTarget().CmdExt = oldCmdExt;
            return CmdExt;
        };
        ...
        p.lib = {
            ...
            recursiveFlattenCommands: _recursiveFlattenCommands,
